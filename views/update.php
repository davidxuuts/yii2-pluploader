...
if (is_array($data)) {
    foreach ($data as $key => $item) {
        ...
        $html .= Html::activeHiddenInput($model, $name . '[' . $key . ']', [
            'class' => 'plupload_file_input',
        ]);
        $html .= '<div class="plupload_file_thumb"><img src="' . $model->attachment->url . '"></div>
            <div class="plupload_file_name"><span>' . basename($model->attachment->name) . '</span></div>
